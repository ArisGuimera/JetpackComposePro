...
| Material| Material 3| 
| :----------------: | :------: |
| ![Imagen del componente AssistChip - Material](../../../assets/chip/assist-chip/chip-assist-material-3-example.webp)              | ![Imagen del componente Button - Material 3](../../../assets/chip/assist-chip/chip-assist-material-3-example.webp) | 
