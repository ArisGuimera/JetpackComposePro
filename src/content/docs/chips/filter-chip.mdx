...
| Material| Material 3| 
| :----------------: | :------: |
| ![Imagen del componente FilterChip - Material](../../../assets/chip/filter-chip/chip-filter-material-3-example.webp)  | ![Imagen del componente FilterChip - Material](../../../assets/chip/filter-chip/chip-filter-material-3-example.webp) | 
