...
BottomNavigation debería contener varios `BottomNavigationItem`s que reprensentarían cada una de las pantallas principales.
...
content | Contenido que almacenará la `NavigationBar`, nomrmalmente 3-5 `NavigationBarItem`s.
