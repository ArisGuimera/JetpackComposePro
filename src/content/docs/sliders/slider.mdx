...
| Material| Material 3| 
| :----------------: | :------: |
| ![Imagen del componente Button - Material](../../../assets/sliders/slider-header.webp)              | ![Imagen del componente Button - Material 3](../../../assets/sliders/slider-header.webp) | 


Un ```Slider``` es un componente que permite al usuario seleccionar un valor continuo entre dos extremos. El valor seleccionado se puede usar para controlar una función en la aplicación.
