...
<Tabs>
<TabItem label="Tabs Secundarios">

<center>
  ![Imagen del componente Tab Secondary](../../../assets/tab/tab-secondary.webp)
</center>
...
<TabItem label="Tabs Primarios">

<center>
  ![Imagen del componente Tab Primary](../../../assets/tab/tab-primary.webp)
</center>
...
fun TabExample() {
    val tabs = listOf(
        ...
        TabData("Profile", Icons.Default.Person),
        TabData("Setting", Icons.Default.Settings)
    )
    val selectedTab = remember { mutableStateOf(0) }
