...
| Material| Material 3| 
| :----------------: | :------: |
| ![Imagen del componente BottomSheet - Material](../../../assets/sheets/bottom-sheet-m2.webp)              | ![Imagen del componente BottomSheet - Material 3](../../../assets/sheets/bottom-sheet.webp) | 
...
```
Nota: consulte las últimas versiones de M2 [desde aquí](https://developer.android.com/jetpack/androidx/releases/compose-material).
</TabItem>
...
```
Nota: consulte las últimas versiones de M3 en la página de lanzamientos de Compose Material 3 [desde aquí](https://developer.android.com/jetpack/androidx/releases/compose-material3).
</TabItem>
</Tabs>
