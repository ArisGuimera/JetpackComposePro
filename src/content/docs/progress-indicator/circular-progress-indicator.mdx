...
Perteneciente a los indicadores de progreso, el `CircularProgressIndicator` es un componente definido como el trazo de un diámetro circular animado, es utilizado para representar visualmente el avance de una operación. También puede ser utilizado para indicar la ejecución de alguna tarea sin proporcionar indicios de que tan próxima esté a finalizar.
...
:::tip[Fuente]
Puedes acceder a la documentación oficial de Google donde se especifica la implementación del componente tanto para [Material](https://developer.android.com/reference/kotlin/androidx/compose/material/package-summary#CircularProgressIndicator(androidx.compose.ui.Modifier,androidx.compose.ui.graphics.Color,androidx.compose.ui.unit.Dp,androidx.compose.ui.graphics.Color,androidx.compose.ui.graphics.StrokeCap)) como para [Material3](https://developer.android.com/reference/kotlin/androidx/compose/material3/package-summary#CircularProgressIndicator(androidx.compose.ui.Modifier,androidx.compose.ui.graphics.Color,androidx.compose.ui.unit.Dp,androidx.compose.ui.graphics.Color,androidx.compose.ui.graphics.StrokeCap)).

También te recomendamos dar un vistazo a la página oficial de [Material](https://m2.material.io/components/progress-indicators) y [Material3](https://m3.material.io/components/progress-indicators/overview) donde podrás encontrar guías de uso, especificaciones visuales del componente y consideraciones de accesibilidad.
:::
...
Por defecto el componente no tiene especificado ninguna animación entre los valores del progreso, por lo que el cambio del componente en la UI será instantáneo. No obstante es posible apoyarse de `ProgressIndicatorDefaults.ProgressAnimationSpec` para animar el cambio del componente a lo largo del progreso tal y como se muestra en el ejemplo de la parte superior.
:::
