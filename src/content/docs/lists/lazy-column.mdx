...
import LazyColumnMaterial3 from '../../../assets/lazy-column/lazy_column_material3.png';
...
| Material 3 | 
| :------: |
| <Image src={LazyColumnMaterial3} alt="Imagen de ejemplo de LazyColumn" width="450rem"/> | 
...
<Tabs>
<TabItem label="Material 3 - LazyColumn">
...
<TabItem label="Material 3 - LazyColumn con cabecera">
