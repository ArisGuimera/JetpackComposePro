...
La implementación del componente `List item` en `Material` y `Material 3` son similares, pero hay algunas diferencias importantes.
:::
...
:::tip[Fuente]
Puedes acceder a la documentación oficial de AndroidDeveloper
[desde aquí](https://developer.android.com/jetpack/compose/lists?hl=es-419).
:::
...
Este nuevo componente es fácil de usar y personalizar.
 PD: No tiene que usarse exclusivamente para elemento de la lista!
