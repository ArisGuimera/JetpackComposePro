...
<CardGrid>
  <ExpandLinkCard
    title="App Bars"
    description="Barras de herramientas que proporcionan funciones de navegación y acciones."
    href="/app-bars/bottom-app-bar/"
    imagePath="https://www.jetpackcompose.pro/_astro/bottomappbar-header-material-3.132c8bdd_Z261Gbc.webp"
  />
    <ExpandLinkCard
    title="Badges"
