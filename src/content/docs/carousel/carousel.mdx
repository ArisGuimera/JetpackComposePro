...
|                                                        Material                                                        | Material 3 |
| :--------------------------------------------------------------------------------------------------------------------: | :--------: |
| ![Demostración de un Horizontal Pager en un dispositivo android](../../../assets/carousel/horizontal-pager-simple.gif) |
...
| pageCount                 | Función lambda que devuelve el número total de items que tendrá el carousel. Es una función para soportar casos donde se agreguen más elementos al carousel. |
  ...
  <TabItem label="Material 3"></TabItem>
</Tabs>
...
![Demostración de un Horizontal Pager en un dispositivo android](../../../assets/carousel/horizontal-pager-con-controles.gif)
...
![Demostración de un Horizontal Pager en un dispositivo android](../../../assets/carousel/horizontal-pager-con-indicadores.gif)
...
```
  ...
  <TabItem label="Material3"></TabItem>
</Tabs>
