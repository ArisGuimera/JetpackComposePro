...
Los `DatePicker` le dan al usuario la posibilidad de seleccionar una fecha, preferiblemente deben ser integrados en un cuadro de dialogo, como un `DatePickerDialog`.

De porfa predeterminada los `DatePicker` permiten seleccionar la fecha atreves de un de un calendario. Sin embargo también permite cambiar a el modo entrada de fecha, para una entrada de datos utilizando los números de el teclado

Este componente fue agregado en Material3
...
<Tabs>
<TabItem label="Modo calendario">

<center>
  ![Imagen del componente SuggestionChip - Material
  ](../../../assets/pickers/datepicker/date-picker-calendar-material-3-example.png)
</center>
...
<TabItem label="Modo entrada de datos">

<center>
  ![Imagen del componente SuggestionChip - Material
  ](../../../assets/pickers/datepicker/date-picker-data-entry-mode-material-3-example.png)
</center>
...
DatePicker te devuelve la fecha en milisegundos, debes utilizar un conversor para convertirlo a el formato deseado
