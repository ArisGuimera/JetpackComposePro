...
| elevation | La coordenada "z" en la que colocar el SnackBar. Esto controla el tamaño de la sombra debajo de SnackBar. |
...
Si necesitas mostrar el Snackbar por defecto en la pantalla, usa ScaffoldState.snackbarHostState y SnackbarHostState.showSnackbar:
```kotlin frame="terminal"
@Composable
fun MySnackbar() {
...
| Inicio  | Resultado |
|---------|-----------|
| ![Snackbar por defecto m3](../../../assets/snackbar/example_snackbar_default_m3_start.webp) | ![Snackbar por defecto m3](../../../assets/snackbar/example_snackbar_default_m3_end.webp) |
